...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/api/feedback', { input });
  ...
  return (
    <div className="min-h-screen bg-[#F4C4A0] flex flex-col items-center p-4">
      <nav className="w-full bg-[#F5E0D0] shadow-md rounded-b-xl px-6 py-4 flex items-center justify-between fixed top-0 left-0 right-0 z-20">
        <div className="flex items-center">
          <button onClick={handleBackToApp}  className="text-2xl font-extrabold text-[#1d2b5a] tracking-tight">Feedbacker</button>
        </div>
      ...
      <div className={`max-h-[60vh] h-[60vh]
        ...
        bg-[#F5E0D0] shadow-xl rounded-3xl p-6 sm:p-8 mx-auto flex
